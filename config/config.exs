...
config :channel, Channel.Web.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "94tJaReWHmXpzPGLsX7LMi3UXD1WZwZB1L7+Zp/KL9YhspYx0NRpcjBrIJMfWi6Q",
  render_errors: [view: Channel.Web.ErrorView, accepts: ~w(json)],
  pubsub: [name: Channel.PubSub,
...
config :guardian, Guardian,
  ...
  serializer: Channel.GuardianSerializer
